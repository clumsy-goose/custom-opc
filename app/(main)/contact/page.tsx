  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="bg-canvas rounded-xl shadow-sm p-8 md:p-12 space-y-10">
          ...
          <section>
            ...
            <div className="flex items-center space-x-3 p-4 bg-surface-soft rounded-2xl">
          ...
          <section>
            ...
            <ul className="text-mute space-y-2 mb-6 ml-1">
            ...
            <div className="flex flex-col items-center sm:items-start">
              <div className="border border-hairline-soft rounded-xl p-4 bg-surface-soft inline-block">
                <Image
              ...
              <p className="text-xs text-ash mt-3">二维码每 7 天更新，如已失效请发邮件告知</p>
            </div>
          </section>
